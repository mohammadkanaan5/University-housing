        ...
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5 ">
                <div class="image-upload">
                    <img class="rounded-circle mt-5" width="150px" alt="Upload Image" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <select class="select btn btn-secondary" id='section'   name='section' required>
                                ...
                                <option class='dropdown-item en' hidden value="informatics">المعلوماتية</option>
